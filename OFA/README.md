...
# OFA-X
This repository is a fork of [OFA-Sys/OFA](https://github.com/OFA-Sys/OFA) and contains all code necessary to train OFA on 
VL-NLE tasks (VQA-X, e-SNLI-VE, VCR) for the [e-ViL benchmark](https://github.com/maximek3/e-ViL). We cannot guarantee
that the code is fully compatible with the original OFA repository.


Below you can find the original OFA README.
---
